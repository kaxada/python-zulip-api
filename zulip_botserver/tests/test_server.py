...
class BotServerTests(BotServerTestCase):
    ...
    def test_load_lib_modules(self) -> None:
        ...
        with self.assertRaisesRegex(SystemExit, f"""Error: Bot "{root_dir}/zulip_bots/zulip_bots/bots/helloworld.py" doesn\'t exist. Please make sure you have set up the botserverrc file correctly."""):
            path = Path(
